...
\begin{enumerate}[a)]
	...
	\begin{align*}
		...
		= & \frac{1}{N}\sum_i^N \frac{Y_i\frac{1}{M}\sum_{m=1}^M\lambda((\mu+\sigma u_{im})X_i)X_i}{\frac{1}{M}\sum_{m=1}^M\Lambda((\mu+\sigma u_{im})X_i)} \\
		& - (1-Y_i)\frac{1}{N}\sum_i^N \frac{(1-Y_i)\frac{1}{M}\sum_{m=1}^M\lambda((\mu+\sigma u_{im})X_i)X_i}{1-\frac{1}{M}\sum_{m=1}^M\Lambda((\mu+\sigma u_{im})X_i)}  
	\end{align*}
	For $\sigma$:
		\begin{align*}
		...
		= & \frac{1}{N}\sum_i^N \frac{Y_i\frac{1}{M}\sum_{m=1}^M\lambda((\mu+\sigma u_{im})X_i)X_i u_{im}}{\frac{1}{M}\sum_{m=1}^M\Lambda((\mu+\sigma u_{im})X_i)} \\
		& - (1-Y_i)\frac{1}{N}\sum_i^N \frac{(1-Y_i)\frac{1}{M}\sum_{m=1}^M\lambda((\mu+\sigma u_{im})X_i)X_i u_{im}}{1-\frac{1}{M}\sum_{m=1}^M\Lambda((\mu+\sigma u_{im})X_i)}  
	\end{align*}
